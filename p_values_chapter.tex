...
Иногда статистическая сумма (evidence) в знаменателе нужно, хотя, казалось бы, для вычисления апостериорных вероятностей она совершенно не нужна. Представим себе, что у нас есть две гипотезы $A$ и $B$.
